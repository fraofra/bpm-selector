...
# --- HEADER E TITOLO ---
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>🎯 BPM - Selettore Chicchette</h1>", unsafe_allow_html=True)
st.markdown("---")

# --- SELEZIONE CAMPIONATO ---
with st.sidebar:
    st.header("⚽ Seleziona il Campionato")
